...
import { getDaysUntilDue, getTodayDateKey, getUrgencyRank } from "@/lib/loans/urgency";
...
export default async function DashboardPage() {
  const { loans, metrics: dashboardMetrics, error } = await getDashboardData();
  ...
  return (
    <main className="page-stack">
      <PageHeader
        eyebrow="Today"
        title="Dashboard"
        description="Live loan metrics from your Supabase account."
